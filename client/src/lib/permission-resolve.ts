...
export const PERMISSION_FALLBACKS: Partial<Record<PermissionKey, PermissionKey>> = {
  ...
  viewSalesReports: 'viewReports',
  viewPurchaseReports: 'viewReports',
  viewInventoryReports: 'viewReports',
  viewCustomerReports: 'viewReports',
  viewSupplierReports: 'viewReports',
  viewProductReports: 'viewReports',
  ...
  getDesignations: 'getEmployees',
  createDesignations: 'getDesignations',
  manageDesignations: 'getDesignations',
  deleteDesignations: 'getDesignations',
