...
export const ROUTE_RULES: RouteRule[] = [
  ...
  { prefix: '/mobile-shop/used-phones/new-phones', businessTypes: ['mobile_shop'], anyPermission: ['viewNewPhones'] },
  { prefix: '/mobile-shop/used-phones/old-phones', businessTypes: ['mobile_shop'], anyPermission: ['viewUsedPhones'] },
  { prefix: '/mobile-shop/used-phones', businessTypes: ['mobile_shop'], anyPermission: ['viewUsedPhones', 'viewNewPhones'] },
