...
const en: Record<string, string> = {
    ...
    "salesmen_management_description": "Turn staff logins into a tracked sales team with commission rates.",
    "add_salesman": "Add Salesman",
    "add_salesman_description": "Turn an existing staff login into a salesman with a commission profile.",
    "edit_salesman": "Edit Salesman",
    "edit_salesman_description": "Update this salesman’s commission profile.",
    "all_salesmen": "All Salesmen",
    "salesmen_list_description": "Every staff login tracked as a salesman, and their commission rate",
    "no_salesmen_found": "No salesmen yet — add one from your existing staff.",
