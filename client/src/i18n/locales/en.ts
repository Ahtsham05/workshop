...
const en: Record<string, string> = {
    ...
    "supplier_dialog_section_primary_new": "Personal & Contact Details",
    "supplier_dialog_section_primary_edit": "Personal & Contact Details",
    "supplier_dialog_section_primary_desc": "English and Urdu name, contact details, address, and opening balance.",
    "supplier_dialog_section_photos_title": "Identity & Documents (Optional)",
    "supplier_dialog_section_photos_desc": "Optional profile photo and CNIC front and back.",
    "total_suppliers": "Total Suppliers",
    "outstanding_payable": "Outstanding balance",
    "suppliers_added_this_month": "Added this calendar month",
    "quick_add_supplier": "Quick Add Supplier",
    "quick_add_supplier_desc": "Add a new supplier in seconds",
    ...
    "customer_dialog_section_primary_new": "Personal & Contact Details",
    "customer_dialog_section_primary_edit": "Personal & Contact Details",
    "customer_dialog_section_primary_desc": "English and Urdu name, contact details, address, and opening balance.",
    "customer_dialog_section_photos_title": "Identity & Documents (Optional)",
    "customer_dialog_section_photos_desc": "Optional profile photo and CNIC front and back.",
    "customer_dialog_section_additional_title": "Additional Information (Optional)",
    "customer_dialog_section_additional_desc": "Classification, credit terms, and internal notes for this customer.",
    ...
    "payment_terms_net_15": "Net 15",
    "payment_terms_net_30": "Net 30",
    "payment_terms_net_60": "Net 60",
    "customer_notes_placeholder": "Add any additional notes about this customer...",
    ...
    "customers_added_this_month": "Added this calendar month",
    "quick_add_customer": "Quick Add Customer",
    "quick_add_customer_desc": "Add a new customer in seconds",
    "opening_balance": "Opening Balance",
    "save_customer": "Save Customer",
    "customer_statement": "Statement",
    "customer_statement_desc": "View ledgers and generate customer statements",
    "supplier_statement": "Statement",
    "supplier_statement_desc": "View ledgers and generate supplier statements",
    ...
    "convert_quotation_description": "Finalize this quotation as a real sale. Stock will be deducted and accounts updated.",
    "convert_to_invoice": "Convert to Invoice",
    "quotation_converted_success": "Quotation converted to invoice successfully",
    "quotation_convert_failed": "Failed to convert quotation",
    "converting": "Converting...",
    "credit_requires_customer": "Credit invoices require a registered customer.",
    "conversion_notes_placeholder": "Add a note for this conversion",
    ...
    "warning_existing_products": "Warning: Importing will add new products. Existing products with the same barcode will not be affected. Any category or sub-category name that doesn't already exist will be created automatically.",
    "products_imported_with_notes": "{{count}} product(s) imported with notes — check units/suppliers",
    "importing": "Importing",
    "import": "Import",
    ...
    "drag_drop_or_browse": "Drag & drop or browse",
    ...
    "salesmen_management_description": "Track your sales team and commission rates — whether or not they have a staff login.",
    "add_salesman": "Add Salesman",
    "add_salesman_description": "Link an existing staff login, or add a salesman with no login of their own.",
    "edit_salesman": "Edit Salesman",
    "edit_salesman_description": "Update this salesman’s commission profile.",
    "all_salesmen": "All Salesmen",
    "salesmen_list_description": "Every salesman tracked, linked to a staff login or standalone, and their commission rate",
    "no_salesmen_found": "No salesmen yet — link a staff login or add a standalone one.",
    "link_existing_user": "Link Existing User",
    "new_salesman": "New Salesman",
    "name": "Name",
    "enter_salesman_name": "Enter salesman name",
    "standalone_salesman_hint": "No login of their own — a cashier will attribute sales to them by name.",
    "linked": "Linked",
    "standalone": "Standalone",
    "staff_user": "Staff User",
    "select_staff_user": "Select a staff user...",
    "search_users": "Search users...",
    "no_eligible_users": "No eligible users (already salesmen, or none exist)",
    "staff_user_hint": "Their existing login is reused — this just adds a commission profile on top.",
    "default_commission_rate": "Default Commission Rate (%)",
    "default_commission_rate_hint": "% of the sale amount this salesman earns, used when no more specific rule applies.",
    "general_commission_rate": "General Rate (%)",
    "general_commission_rate_hint": "Fallback used for any module below that's left blank (and not covered by a branch/organization rule).",
    "commission_rates_by_module": "Commission Rates by Module",
    "commission_rates_by_module_hint": "Set a different rate per module — leave blank to use the General Rate above. e.g. Sales 1%, Services 2.5%.",
    "module_rule_hint": "A specific module beats a general rate at the same scope.",
    "salesman_section_identity": "Salesman Identity",
    "salesman_section_identity_desc": "Who this salesman is and how to reach them.",
    "salesman_section_commission": "Commission Rates",
    "salesman_section_commission_desc": "Set the fallback rate, then override it per module if needed.",
    "salesman_section_notes": "Notes & Status",
    "salesman_section_notes_desc": "Optional context, plus whether this salesman can take new sales.",
    "active_status": "Active Status",
    "salesman_active_status_hint": "Inactive salesmen can’t be assigned to new sales.",
    "salesman_active_hint": "Salesman can be assigned to new sales.",
    "salesman_module_rate_table_module": "Module",
    "salesman_module_rate_table_rate": "Rate (%)",
    "salesman_module_rate_table_preview": "Preview",
    "salesman_preview_base_note": "Preview amounts are calculated on a base of {{amount}}. Change the general rate or module rates to see updated previews.",
    "salesman_summary_preview_title": "Summary Preview",
    "salesman_summary_general_rate": "General Rate",
    "salesman_summary_highest_module": "Highest Module",
    "salesman_summary_lowest_module": "Lowest Module",
    "total_salesmen": "Total Salesmen",
    ...
    "from_n_transactions": "From {{count}} transactions",
    "filter": "Filter",
    "transaction_type": "Transaction Type",
    "no_commission_entries_match_filter": "No entries match the selected filter.",
    "code": "Code",
    ...
    "failed_to_delete_salesman": "Failed to delete salesman",
    "delete_salesman": "Delete Salesman",
    "delete_salesman_confirmation": "Are you sure you want to remove this salesman? This action cannot be undone.",

    // Commission Rules
    "commission_rules": "Commission Rules",
    "add_commission_rule": "Add Rule",
    "edit_commission_rule": "Edit Commission Rule",
    "commission_rule_description": "The most specific active rule wins: salesman-specific beats branch, branch beats the organization default.",
    "scope": "Applies To",
    "organization_default": "Organization default",
    "specific_branch": "A specific branch",
    "specific_salesman": "A specific salesman",
    "branch": "Branch",
    "select_branch": "Select a branch...",
    "salesman": "Salesman",
    "select_salesman": "Select a salesman...",
    "commission_rate": "Commission Rate (%)",
    "effective_from": "Effective From",
    "effective_to": "Effective To",
    "leave_blank_open_ended": "Leave blank for open-ended",
    "commission_rule_active_hint": "Inactive rules are skipped when resolving a rate.",
    "commission_rule_created_successfully": "Commission rule created successfully",
    "commission_rule_updated_successfully": "Commission rule updated successfully",
    "commission_rule_deleted_successfully": "Commission rule deleted successfully",
    "failed_to_delete_commission_rule": "Failed to delete commission rule",
    "delete_commission_rule": "Delete Commission Rule",
    "delete_commission_rule_confirmation": "Are you sure you want to delete this commission rule? This action cannot be undone.",
    "test_resolved_rate": "Test: What rate applies right now?",
    "test_resolved_rate_description": "Pick a salesman to see which rule (if any) currently sets their commission rate.",
    "check_rate": "Check Rate",
    "checking": "Checking...",
    "salesman_specific_rule": "Salesman-specific rule",
    "branch_rule": "Branch rule",
    "organization_rule": "Organization default rule",
    "salesman_profile_default": "Salesman's own default rate",
    "no_rule_configured": "No rule configured",
    "all_commission_rules": "All Commission Rules",
    "commission_rules_list_description": "Salesman-specific rules beat branch rules, which beat the organization default",
    "applies_to": "Applies To",
    "no_commission_rules_found": "No rules yet — salesmen fall back to their own default commission rate.",
    "commission_ledger": "Commission Ledger",
    "commission_ledger_description": "Every commission credited or reversed, with a running balance per salesman",
    "commission_earned": "Earned",
    "commission_reversed": "Reversed",
    "commission_payment": "Paid",
    "adjustment": "Adjustment",
    "reference": "Reference",
    "rate": "Rate",
    "debit": "Debit",
    "no_commission_entries_found": "No commission entries yet — they appear once a salesman-attributed invoice is finalized.",
    "pay_commission": "Pay Commission",
    "outstanding_balance": "Outstanding balance",
    "commission_payment_recorded": "Commission payment recorded",
    "void_payment": "Void Payment",
    "void_payment_confirmation": "Are you sure you want to void this commission payment? The amount will be added back to the salesman's balance.",
    "commission_payment_voided": "Commission payment voided",

    // Partners & Investors
    "partners_management": "Partners",
    "partners_management_description": "Track business partners and product investors, and pay out their share of profit automatically as sales happen.",
    "add_partner": "Add Partner",
    "add_partner_description": "A business partner or product investor entitled to a share of profit — set up their profit-share rules separately once they’re added.",
    "edit_partner": "Edit Partner",
    "partner_type": "Type",
    "business_partner": "Business Partner",
    "product_investor": "Product Investor",
    "partner_type_hint": "Just a label for your own organization — a partner’s actual profit share is set up separately as one or more rules.",
    "organization_wide": "Organization-wide",
    "partner_branch_hint": "Leave blank if this partner isn’t tied to one specific branch.",
    "partner_active_status_hint": "Inactive partners are hidden from new rule pickers.",
    "all_partners": "All Partners",
    "partners_list_description": "Business partners and product investors entitled to a share of profit",
    "no_partners_found": "No partners yet — add a business partner or product investor.",
    "delete_partner": "Delete Partner",
    "delete_partner_confirmation": "Are you sure you want to delete this partner? This is blocked if they have any profit-share rules or ledger history — deactivate them instead in that case.",
    ...
    // Profit-Share Rules
    "profit_share_rules": "Profit-Share Rules",
    "add_rule": "Add Rule",
    "edit_rule": "Edit Profit-Share Rule",
    "profit_share_rule_description": "Several partners can hold independent rules on the same product or the same organization — all of them earn on the same sale.",
    "select_partner": "Select a partner...",
    "a_specific_product": "A specific product",
    "a_specific_variant": "A specific product variant",
    "a_specific_batch": "A specific batch / lot",
    "a_specific_branch": "A specific branch (all products)",
    "whole_organization": "The whole organization",
    "variant": "Variant",
    ...
    "fixed_per_unit": "Fixed amount per unit sold",
    "rate_percent": "Rate (%)",
    "rate_per_unit": "Rate (Rs / unit)",
    "rule_active_status_hint": "Inactive rules are skipped — no future sale credits this partner.",
    "all_profit_share_rules": "All Profit-Share Rules",
    "profit_share_rules_list_description": "Several partners can independently earn on the same product or the same organization — they are not mutually exclusive.",
    "no_rules_found": "No profit-share rules yet — add one to start crediting a partner.",
    "delete_rule": "Delete Profit-Share Rule",
    "delete_rule_confirmation": "Are you sure you want to delete this rule? Past ledger entries it already created are not affected — only future sales stop crediting this partner.",
    "profit_share_rule_created_successfully": "Profit-share rule created successfully",
    "profit_share_rule_updated_successfully": "Profit-share rule updated successfully",
    "profit_share_rule_deleted_successfully": "Profit-share rule deleted successfully",
    "failed_to_delete_rule": "Failed to delete rule",
    "preview_active_claims": "Preview: who currently earns from this?",
    "preview_active_claims_description": "Pick a product to see every partner currently entitled to a share when it sells, plus any organization/branch-wide partners.",
    "check": "Check",
    "no_active_claims": "No partner currently has an active claim here.",
    "organization": "Organization",

    // Partner Ledger & Payouts
    "partner_ledger": "Ledger & Payouts",
    "partner_ledger_description": "Every share credited or reversed, with a running balance per partner",
    "share_earned": "Earned",
    "share_reversed": "Reversed",
    "share_payment": "Paid",
    "no_ledger_entries_found": "No entries yet — they appear once a partner-linked sale is finalized.",
    "pay_partner": "Pay Partner",
    "partner": "Partner",
    "void_partner_payment_confirmation": "Are you sure you want to void this payment? The amount will be added back to the partner's balance.",
    "partner_payment_voided": "Partner payment voided",
    "partner_payment_recorded": "Partner payment recorded",

    // Shared action labels (also used by the Partners feature)
    ...
    "add_category_named": "Add \"{{name}}\" as new category",
    ...
    "manage_product_subcategories": "Organize products with sub-categories under each main category.",
    "search_subcategories": "Search sub-categories...",
    ...
    "subcategory_names": "Sub Category Names",
    "subcategory_image": "Sub Category Image",
    "parent_category": "Parent Category",
    "main_category": "Main Category",
    "select_main_category_placeholder": "Select a main category",
    "enter_subcategory_name_placeholder": "e.g. Wireless Earbuds",
    "add_another_subcategory": "Add another sub-category",
    "add_multiple_subcategories_hint": "Add as many sub-category names as you need — press Enter after typing a name to quickly add the next row.",
    "creating_count_subcategories": "Adding {{count}} sub-categories",
    "will_be_added_under": "This will be added under",
    "create_subcategory": "Create Sub Category",
    "create_subcategories_count": "Create {{count}} Sub Categories",
    "update_subcategory": "Update Sub Category",
    "update_subcategory_description": "Update this sub-category's details. Click save when you're done.",
    "create_subcategory_description": "Pick a main category, then add one or more sub-category names at once.",
    "subcategory_created_successfully": "Sub-category created successfully",
    "subcategories_created_successfully_count": "{{count}} sub-categories created successfully",
    "subcategory_updated_successfully": "Sub-category updated successfully",
    "subcategory_deleted_successfully": "Sub-category deleted successfully",
    "subcategory_creation_failed": "Failed to create sub-category",
    "subcategory_update_failed": "Failed to update sub-category",
    "subcategory_deletion_failed": "Failed to delete sub-category",
    "delete_subcategory_confirmation": "Are you sure you want to delete this sub-category",
    "no_subcategories_found": "No sub-categories found",
    "select_subcategories": "Select sub-categories",
    "select_category_first_hint": "Select a category first",
    "type_a_name_to_create_subcategory": "Type a name above to create a new sub-category",
    "create_subcategory_under": "Create \"{{name}}\" under {{category}}",
    "no_subcategories_hint": "Create your first sub-category to start organizing products in more detail.",
    "no_categories_yet_title": "No categories yet",
    "no_categories_yet_hint": "You need at least one category before you can add sub-categories.",
    "create_category_first_hint": "Add a category first",
    ...
    "import_as_active": "Make products active",
    "import_as_active_on_hint": "Ready to sell as soon as they're imported",
    "import_as_active_off_hint": "Imported as inactive — review, then activate from the product list",
    "products_imported_active_hint": "They're active and ready to sell.",
    "products_imported_inactive_hint": "They're inactive — activate them from the product list when ready.",
    "products_already_imported": "{{count}} product(s) were already at this branch",
    "products_import_some_failed": "{{imported}} imported, {{failed}} couldn't be — see the highlighted rows",
    "products_import_fix_rows": "{{count}} product(s) need opening stock details",
    "products_import_select_all_failed": "Couldn't select all products. Please try again.",
    "select_all_n": "Select all {{count}}",
    "select_this_page_n": "Select this page ({{count}})",
    "clear_selection": "Clear selection",
    "n_variants": "{{count}} variants",
    "serial": "Serial",
    "import_stock_per_variant_hint": "Add stock per variant after import",
