...
export const SupplierAgingReport = forwardRef<{ exportToExcel: () => void }, {}>((_, ref) => {
  ...
  const { data, isFetching: isLoading } = useGetSupplierAgingReportQuery({ asOfDate: queryAsOfDate, bucketSize })
    ...
    <div className='space-y-6'>
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t('Aging buckets are calculated against the balance owed as of this date, using the selected aging period')}</CardDescription>
        </CardHeader>
