...
function resolvePhone(phone?: string | null, whatsapp?: string | null) {
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          ...
          variant={variant}
          className={cn(
            'text-[#25D366] hover:text-[#20bd5a] hover:bg-green-50',
      ...
      <TooltipContent>
        {wa?.isReady ? 'Send via connected WhatsApp' : wa ? 'Connect WhatsApp to send messages' : 'Open WhatsApp'}
      </TooltipContent>
    </Tooltip>
  )
}
