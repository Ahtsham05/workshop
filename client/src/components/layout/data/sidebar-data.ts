      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { title: 'Bank Accounts Report', url: '/reports?tab=my-wallet' as never, icon: WalletCards, requiredFeature: 'wallet' },
            { title: 'Bank & Cash Position Report', url: '/reports?tab=bank-position' as never, icon: Landmark, requiredFeature: 'wallet' },
        ...
        },
        {
          ...
          businessTypes: ['mobile_shop'],
          items: [
            { title: 'Load Report', url: '/reports?tab=load' as never, icon: Smartphone, requiredFeature: 'load' },
            { title: 'Sim Sale Report', url: '/reports?tab=sim-sale' as never, icon: Smartphone },
            { title: 'Repair Report', url: '/reports?tab=repair' as never, icon: Wrench, requiredFeature: 'repair' },
            { title: 'Services Report', url: '/reports?tab=services' as never, icon: Sparkles },
            { title: 'Bill Payments Report', url: '/reports?tab=bill-payments' as never, icon: QrCode, requiredFeature: 'bill_payment' },
            // Email must match AGENT_BILL_EMAIL in features/mobile-shop/bill-payments
            { title: 'Agent Bills Report', url: '/reports?tab=agent-bills' as never, icon: FileText, allowedEmails: ['bilalmulazim7086@gmail.com'] },
            { title: 'Installments Report', url: '/reports?tab=installments' as never, icon: IconCalendar },
            { title: 'Mobile Phone Report', url: '/reports?tab=mobile-phones' as never, icon: Smartphone },
          ],
        },
        {
