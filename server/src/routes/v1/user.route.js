...
router
  .route('/')
  .post(auth(), checkPermission('createUsers'), validate(userValidation.createUser), userController.createUser)
...
router
  ...
  .delete(auth(), checkPermission('deleteUsers'), validate(userValidation.deleteUser), userController.deleteUser);
