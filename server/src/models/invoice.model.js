...
const InvoiceSchema = new mongoose.Schema({
    ...
    // Salesman credited with this sale for commission purposes — a SalesmanProfile ref
    // (same identity CommissionRule.salesmanId and SalesmanCommissionLedger.salesmanId key
    // off), distinct from createdBy: the person entering the sale isn't always the one who
    // made it.
    salesmanId: { type: mongoose.Schema.Types.ObjectId, ref: 'SalesmanProfile', default: null, index: true },
...
// invoiceNumber is now generated by documentNumberingService.generateNextNumber (needs
// organizationId + the org's customizable format, neither of which a model-level pre-save
// hook can reach cleanly) — see invoice.service.js#createInvoice / #convertQuotationToInvoice.
