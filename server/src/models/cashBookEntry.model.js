...
const cashBookEntrySchema = new mongoose.Schema(
  {
    ...
    source: {
      type: String,
      enum: ['sale', 'load', 'repair', 'service', 'purchase', 'expense', 'other', 'sales_return', 'purchase_return', 'bill_payment', 'opening_balance', 'installment', 'wallet', 'used_phone_buyback', 'commission_payment', 'partner_share_payment'],
      required: true,
    },
    amount: {
      type: Number,
