...
module.exports.salesmanProfileService = require('./salesmanProfile.service.js');
module.exports.commissionRuleService = require('./commissionRule.service.js');
module.exports.salesmanCommissionLedgerService = require('./salesmanCommissionLedger.service.js');
module.exports.salesmanCommissionPaymentService = require('./salesmanCommissionPayment.service.js');
module.exports.partnerService = require('./partner.service.js');
module.exports.partnerProfitShareRuleService = require('./partnerProfitShareRule.service.js');
module.exports.partnerProfitShareLedgerService = require('./partnerProfitShareLedger.service.js');
module.exports.partnerPaymentService = require('./partnerPayment.service.js');
module.exports.commissionEngineService = require('./commissionEngine.service.js');
...
module.exports.walletTransferService = require('./walletTransfer.service.js');
module.exports.paymentVoucherService = require('./paymentVoucher.service.js');
module.exports.receiptVoucherService = require('./receiptVoucher.service.js');
module.exports.bankReconciliationService = require('./bankReconciliation.service.js');
...
module.exports.newPhoneService = require('./newPhone.service.js');
