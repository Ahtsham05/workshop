...
const createRole = {
  body: Joi.object().keys({
    ...
    permissions: Joi.object().keys({
      ...
      viewPurchaseOrders: Joi.boolean(),
      createPurchaseOrders: Joi.boolean(),
      editPurchaseOrders: Joi.boolean(),
      deletePurchaseOrders: Joi.boolean(),
      receivePurchaseOrders: Joi.boolean(),
